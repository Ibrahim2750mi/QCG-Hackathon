...
class ProceduralForestTerrain(arcade.Window):
    ...
    def setup(self):
        ...
        self.bg_player = arcade.play_sound(self.bg_ambient_music, volume=1, loop=True)
        self.running_player = arcade.play_sound(self.running_music, volume=0.2, loop=True)
